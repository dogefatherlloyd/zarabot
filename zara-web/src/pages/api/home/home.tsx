...
const Home = ({
  ...
  const contextValue = useCreateReducer<HomeInitialState>({
    initialState: { ...initialState, modelError: null },
  });
  ...
  useEffect(() => {
    if (data) dispatch({ type: 'change', field: 'models', value: data });
  }, [data, dispatch]);

  useEffect(() => {
    dispatch({ type: 'change', field: 'modelError', value: getModelsError(error) });
